...
$(eval $(call nf_add,IPT_SNATP2P,CONFIG_IP_NF_TARGET_SNATP2P, $(P_V4)ipt_SNATP2P))
$(eval $(call nf_add,IPT_HAIRPIN,CONFIG_IP_NF_TARGET_HAIRPIN, $(P_V4)ipt_HAIRPIN))
$(eval $(call nf_add,IPT_DNATP2P,CONFIG_IP_NF_TARGET_DNATP2P, $(P_V4)ipt_DNATP2P))
$(eval $(call nf_add,IPT_LOG,CONFIG_IP_NF_MATCH_LOG, $(P_V4)ipt_log))
...
IPT_BUILTIN += $(IPT_SNATP2P-y)
IPT_BUILTIN += $(IPT_HAIRPIN-y)
IPT_BUILTIN += $(IPT_DNATP2P-y)
IPT_BUILTIN += $(IPT_LOG-y)
