...
#endif
#if !defined(POT_MTD_SIZE)
#warning "POT: Not define macro POT_MTD_SIZE, use default value - 512KB"
#define POT_MTD_SIZE	(512 * KBYTE)	/* bytes, POT partition is 512KB(4 blocks) by default */
#endif
