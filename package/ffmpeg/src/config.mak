...
OPTFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -I$(TOOL_CHAIN_PATH)/include/ -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wundef -O1 -fno-math-errno -G 0 -mips32 
VHOOKCFLAGS=-fPIC
LDFLAGS=  -L$(TOOL_CHAIN_PATH)/lib -Llibavutil/ -Llibavcodec/ -Llibavformat/ -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
# Foxconn, marked by Michael Jiang, 2010.06.03, for minidlna compiling"
# 
...
#
# # Foxconn, ended by Michael Jiang, 2010.06.03, for minidlna compiling"
