...
#define FFMPEG_CONFIGURATION "--enable-shared --enable-gpl --arch=mipsel --cc=mipsel-linux-uclibc-gcc --enable-cross-compile --extra-cflags=-I/projects/hnd/tools/linux/hndtools-mipsel-linux-uclibc-4.2.3/include/ --extra-ldflags=-L/projects/hnd/tools/linux/hndtools-mipsel-linux-uclibc-4.2.3/lib --disable-muxers --disable-encoders --disable-filters --disable-vhook"
