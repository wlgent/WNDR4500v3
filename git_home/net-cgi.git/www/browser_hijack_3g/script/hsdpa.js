...
function set_hsdpa()
{
	...
	if((index == 5 && (cf.isp_type6.selectedIndex != 0 && cf.isp_type6.selectedIndex != 1)) ||(index==14 && cf.isp_type15.selectedIndex != 3 && cf.isp_type15.selectedIndex != 5))
	{
		if(cf.hsdpa_username.value == "")
		{
			alert("Ivalid value!");
	...
	else if(index == 14)
	{
		...
		if(cf.isp_type15.selectedIndex == 0)
			...
			cf.hid_apn.value="";
			cf.hid_accnum.value=6;
		}else if(cf.isp_type15.selectedIndex == 5)
			cf.hid_apn.value="yota";
		else
			set_other_isp();
