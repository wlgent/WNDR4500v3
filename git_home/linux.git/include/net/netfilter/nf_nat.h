...
#define IP_NAT_UDP_ODD_PORT_FULL	1
#define IP_NAT_UDP_EVEN_PORT_FULL	2
#define IP_NAT_TCP_ODD_PORT_FULL	4
#define IP_NAT_TCP_EVEN_PORT_FULL	8

extern unsigned int udp_tcp_port_flags;
#endif
