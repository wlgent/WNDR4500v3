/*
 * wndr4500v3.c - partially based on OpenWrt's add_header.c
 *
...
static void usage(const char *mess)
{
	...
	fprintf(stderr, "Usage: wndr4500v3 input_file output_file\n");
	fprintf(stderr, "\n");
	exit(1);
}
...
int main(int argc, char **argv)
{
	...
	init_crc32();
        ...
        header.magic = htonl(0x27051956); /* 3703 in ascii */
	header.crc = 0;
