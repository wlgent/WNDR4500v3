...
\newpage
   \begin{tabular}{|c||c|c|} \hline
	  ...
	  2009/03/20 & Release V1.0.3.11 & Ronger Pan \\ \hline
	  2009/03/24 & Release V1.0.3.12 & Ronger Pan \\ \hline
	  2009/03/25 & Release V1.0.3.13 & Ronger Pan \\ \hline
	  2009/03/31 & Release V1.0.3.14 & Ronger Pan \\ \hline
	  2009/04/02 & Release V1.0.3.15 & Ronger Pan \\ \hline
	  2009/04/13 & Release V1.0.3.16 & Ronger Pan \\ \hline
          2009/04/17 & Release V1.0.3.17 & Ronger Pan \\ \hline
		  2009/04/27 & Release V1.0.3.18 & Ronger Pan \\ \hline
		  2009/04/29 & Release V1.0.3.19 & Ronger Pan \\ \hline
		  2009/04/30 & Release V1.0.3.20 & Ronger Pan \\ \hline
		  2009/05/08 & Release V1.0.4.20 & Ronger Pan \\ \hline
		  2009/05/15 & Release V1.0.4.21 & Ronger Pan \\ \hline
		  2009/05/22 & Release V1.0.4.22 & Ronger Pan \\ \hline
		  2009/05/31 & Release V1.0.4.23 & Ronger Pan \\ \hline
		  2009/06/02 & Release V1.0.4.24 & Ronger Pan \\ \hline
		  2009/06/12 & Release V1.0.4.25 & Ronger Pan \\ \hline
		  2009/06/16 & Release V1.0.4.26 & Ronger Pan \\ \hline
		  2009/06/26 & Release V1.0.4.27 & Ronger Pan \\ \hline
		  2009/07/02 & Release V1.0.4.28 & Ronger Pan \\ \hline
		  2009/07/08 & Release V1.0.4.29 & Ronger Pan \\ \hline
		  2009/07/13 & Release V1.0.4.30 & Ronger Pan \\ \hline
		  2009/07/22 & Release V1.0.4.31 & Ronger Pan \\ \hline
		  2009/07/22 & Release V1.0.4.32 & Ronger Pan \\ \hline
   \end{tabular}
...
\begin{itemize}
    ...
    \item Tag: \texttt{WNDR3700U-V-1-0-0-0} fixed the following bugs:
\end{itemize}
\begin{enumerate}
\item Function
        \begin{itemize}
        ...
        \end{itemize}
          \begin{itemize}
                \item \texttt{added multi language for wndr3700u}
        \end{itemize}
           \begin{itemize}
                \item \texttt{ported new http server uhttp and its 
			      configuration management tool datalib to wndr3700u}
        \end{itemize}
            \begin{itemize}
        ...
        \end{itemize}
            \begin{itemize}
                \item \texttt{Ported pppoe and pptp of wnr2000 to wndr3700u}
        \end{itemize}
            \begin{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-2} fixed the following bugs:
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-3} fixed the following bugs:
\end{itemize}
...
\item Linux
	...
	\item \texttt{hardcoding board-specific bootargs into WNDR3700U's Linux config.}
...
\item Application
        \begin{itemize}
                \item \texttt{Changed the default hostname to WNDR3700U in ppp, datalib, miniupnpd,net-dump,smtpclient.}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-4} fixed the following bugs:
\end{itemize}
...
\subsection{Steps to burn boot loader and firmware}
        \begin{enumerate}
		\item \texttt{Please burn u-boot-3700V0.3.bin}
		...
		\item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.3.bin;erase 0xbf000000 +0x50000;cp.b 0x80010000 0xbf000000 0x50000}
		...
		\item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.0.4.img" on MS-DOS of your PC.} 
        \end{enumerate}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-5}
\end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-6}
\end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-7}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V0.4.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.3.bin}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammand "tftp -i 192.168.1.1 put WNDR3700U-V1.0.0.7.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-8}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.4.bin}
		\item \texttt{ag7100> erase 0xbf000000 +0x50000}
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.0.8.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-0-9}
\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item \texttt{11811 [PPPoE]"Connect" and "Disconnect" button can not work in connection status page}
	\item \texttt{11826 [PPPoE]Connection Mode of PPPoE can not be changed to Always on or Manually connect.}
	\item \texttt{11873 [Top]Please change the model name to WNDR3700U in top frame's picture}
	\item \texttt{11935 [DHCP-Server]DHCP Server can not be disabled}
	\item \texttt{11937 [WAN Setup]If you change WAN MTU and click apply,the webpage go back to Basic settings page}
	\item \texttt{11942 [Backup Settings]After restore config file,the webpage can not go back because the time in webpage is not enough.}
	\item \texttt{11947 [Intel VIIV]"http://www.routerlogin.com/router-info.htm" page is blank}
	...
	\item \texttt{12165 The LOGO of wndr3700 should be fetched from NETGEAR.}
	\item \texttt{12166 Replace all the strings "WNDR3700U" to "WNDR3700"}
	\item \texttt{12181 [SQA Taipei-1]The product name should be "WNDR3700U", but GUI displays "WNR2000".}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V0.5.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.5.bin}
		\item \texttt{ag7100> erase 0xbf000000 +0x50000}
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.0.9.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-0}
\end{itemize}
\end{itemize}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.0.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-1}
\end{itemize}
\end{itemize}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.1.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-2}
\end{itemize}
\end{itemize}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.2.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-3}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \texttt{12774 [wndr3700][disk management && user management]so many print infomation \\
		...
		\item \texttt{12692    	Many potential issues inside, some settings in \\
						AP94 but you didn¡¯t put it in 3700 script.}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.3.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-4}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V0.6.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.6.bin}
		\item \texttt{ag7100> erase 0xbf000000 +0x50000}
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.4.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-5}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \texttt{12948 Can¡¯t find 3700 in the workgroup through windows explore. }
	\end{itemize}
\end{enumerate}
\begin{enumerate}
	\item GUI
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V0.7.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.7.bin}
		\item \texttt{ag7100> erase 0xbf000000 +0x50000}
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.5.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-6}
\end{itemize}
\end{itemize}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.6.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-7}
\end{itemize}
\end{itemize}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.7.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-8}
\end{itemize}
\end{itemize}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the coammdn "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.8.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-1-9}
\end{itemize}
\end{itemize}
...
\item As below:
		...
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.1.9.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-0}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V0.8.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.8.bin}
		\item \texttt{ag7100> erase 0xbf000000 +0x50000}
		\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.0.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-1}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V0.9.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V0.9.bin}
				\item \texttt{ag7100> erase 0xbf000000 +0x50000}
				\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.1.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-2}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.2.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-3}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		\item 	\texttt{13621 [USB storage]No matter what Network\/Device Name on \
						USB NETStorage (Advanced Settings) page is ,it always work as WNDR3700}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.3.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-4}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.4.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-5}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{13806 [Netgear-Lancelot]If the share name is ?U drive?, then it will only display \
						\\\\wndr3700u on the authentication pop-up dialog not \\\\wndr3700u drive}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{13770 WNDR3700 5G band WDS doesn't work}
	\end{itemize}
\end{enumerate}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.5.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-6}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{13788 [mercury-mms] WNDR3700 2.4G WDS cannot work with itself \
						if security is WEP}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.6.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-7}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{13788 [mercury-mms] WNDR3700 2.4G WDS cannot work with itself if \
						security is WEP}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V1.0.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V1.0.bin}
				\item \texttt{ag7100> erase 0xbf000000 +0x50000}
				\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.7.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-8}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V1.1.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V1.1.bin}
				\item \texttt{ag7100> erase 0xbf000000 +0x50000}
				\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.8.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-2-9}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{14272 [NETGEAR]Defect ID : 165 [USB] Enable http access by default as per \
						USB Spec 1.4}
		\item 	\texttt{14163 [mercury-mms] Defect ID : 144 WNDR3700\_Scan test: Port 53 issue Test \
						fail. It cannot add port 53 in port triggering page.}
		\item 	\texttt{14168 [mercury-mms] Defect ID : 142 WNDR3700\_Scan test: : Attached device \
						list tested fail, the page always shown 22 items.}
		\item 	\texttt{14154 [mercury-mms] Defect ID : 146 WNDR3700: First time router connected \
						to PPPoE, the DNS cannot work.}
		\item 	\texttt{14169 [mercury-mms] Defect ID : 138 WNDR3700\_Scan test: PPPoE stress \
						test fail}
		\item 	\texttt{14059 [mercury-mms] Defect ID : 114 [USB] Access Controls dont seem to apply \
						when accessing via http}
		\item 	\texttt{14158 [mercury-mms] Defect ID : 143 WNDR3700\_Scan test: Big Files (About 3G \
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.2.9.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-0}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{14373 [NETGEAR] disable DFS channel for 3700}
	\end{itemize}
\end{enumerate}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.0.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-1}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.1.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-2}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{13757 [mercury-mms] DUT will forward all echo/chargen packets to LAN \
						when config port forwarding}
		\item 	\texttt{14165 [mercury-mms] Defect ID : 137 WNDR3700_Scan test: Router reboot \
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.2.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-3}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.3.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-4}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item APPLICATION
	\begin{itemize}
		\item 	\texttt{14369 wndr3700 \/proc\/uptime is not normal}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V1.3.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V1.3.bin}
				\item \texttt{ag7100> erase 0xbf000000 +0x50000}
				\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> set bootcmd 'fsload 80800000 image/uImage;bootm 80800000'}
                \item \texttt{ag7100> saveenv}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.4.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-5}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.5.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-6}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V1.4.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V1.4.bin}
				\item \texttt{ag7100> erase 0xbf000000 +0x70000}
				\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> reset}
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.6.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-7}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.7.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-8}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.8.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-9}
\end{itemize}
\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.9.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-10}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item 	\texttt{14861 [NETGEAR]Defect ID : 197 - WNDR3700 port 5060 issue}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.10.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-11}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item APPLICATION
	\begin{itemize}
		\item 	\texttt{14851 [NAT]ICMP Port Unreachable test is failed}
		\item 	\texttt{14971 [NETGEAR]Test ID (102) - Software -- Router -- \
						Security -- Attack Protection -- TCP SYN Flood \
						(Renamed & Revised Q108)}
		\item 	\texttt{14328 [wmm]When turn off wmm,the througtput is low}
		\item   \texttt{14909   [NETGEAR]Defect ID : 213 - WNDR3700 Scan test - Steam server issue}
	\end{itemize}
\end{enumerate}
...
\begin{enumerate}
       \item GUI
       \begin{itemize}
			\item 	\texttt{13264 [Static route] Route Name shows error in route \
							table with special characters}
			\item 	\texttt{13265 [Static route] Route Name shows not allow 2byte characters}
			\item 	\texttt{13656 [USB storage]Network/Device Name and workgroup should not \
							allow 2 bytes characters}
			\item 	\texttt{14958 [NETGEAR]Test ID (46) - Software -- Router -- Features -- \
							RIP and Static Routing -- Private WAN Capture}
			\item 	\texttt{14977 In Setup Wizard, the GUI is not brought back to Setup Wizard \
							GUI after test button is clicked and test function is done.}
			\item 	\texttt{13018 [QoS]QoS Policy should not allow 2byte characters}
			\item 	\texttt{13019 [QoS]MAC Device List shows error when you input some special \
							characters as device name}
			\item 	\texttt{14959 [NETGEAR]Test ID (59) - RIP and Static Routing -- Special Route Name}
			\item 	\texttt{14980 [QoS]When edit the MAC address QoS Policy,it display two same \
							MAC address in the MAC Device List page}
			\item 	\texttt{13372 [Router Upgrade]when you upgrade from a low version to a high, \
							DUT will go on automatic when you do not click "yes"!}
			\item 	\texttt{15005 [USB storage]Please change the "NETStorage" in pop up message to "Storage"}
			\item 	\texttt{14978 make internet connection active when click ¡°Test¡± button}
		\end{itemize}
\end{enumerate}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.11.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-12}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item APPLICATION
	\begin{itemize}
		\item 	\texttt{15015 add ¡°service name¡± of PPPoE settings into PPP packet}
		\item 	\texttt{15021 [DMZ]TCP packets from WAN PC shouldn't reach DMZ by DMZ server's IP address}
		\item 	\texttt{14954 [NETGEAR]Test ID (31) - Software -- Installation & \
						Management -- WAN & LAN Conflict -- Static IP}
		\item   \texttt{14953 [NETGEAR]Test ID (28) - Software -- Installation & \
						Management -- Logging -- WLAN Incorrect Security}
	\end{itemize}
\end{enumerate}
...
\begin{enumerate}
       \item GUI
       \begin{itemize}
			\item 	\texttt{15089 [USB Storage]Can not edit share folder any more}
			\item 	\texttt{13265 [Static route] Route Name shows not allow 2byte characters}
			\item 	\texttt{13173 [Wireless][a\/n][b\/g\/n]SSID should not allow 2 bytes characters}
			\item 	\texttt{15024 [USB Storage]Sometimes the default USB Device on \
							"Create Network Folder" page is not U:}
			\item 	\texttt{15068 Sometimes create and delete share folder on USB Storage \
							(Advanced Settings) page will make uhttpd error}
		\end{itemize}
\end{enumerate}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.12.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-13}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item APPLICATION
	\begin{itemize}
		\item 	\texttt{[BUG 14744] [DDNS] If there is still no response for ,an implementation MUST do try and re-tries}
		\item 	\texttt{Fix the bug that hostapd will	crash from WEP to WPA or WPA2 security}
	\end{itemize}
\end{enumerate}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.13.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-14}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item APPLICATION
	\begin{itemize}
		\item 	\texttt{[BUG 14952] [NETGEAR]Test ID (23) - Software -- Installation & Management \
						-- Logging -- Include Blocked Sites with}
		\item 	\texttt{14785 [NETGEAR]Defect ID :181-There is strange log in system logs.}
		\item	\texttt{14828 [NETGEAR]Defect ID : 190 - When DDNS update failed because \
						the authentication failed the info showed in DDNS status page is incorrect.}
		\item	\texttt{15024 [USB Storage]Sometimes the default USB Device on "Create Network \
						Folder" page is not U:.}
		\item	\texttt{15074 [Block Service][Firefox & Safari]Protocol, Starting Port, Ending Port, \
						Service Type/User Defined are not gray out when you do not select "User \
						Define" in Firefox and Safari.}
		\item	\texttt{14953 [NETGEAR]Test ID (28) - Software -- Installation & Management -- Logging \
						-- WLAN Incorrect Security.}
		\item	\texttt{15132 [QoS]When QoS is enabled, WAN-LAN throughput between giga bit Ethernet \
						PCs will call the DUT crash.}
	\end{itemize}
\end{enumerate}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.14.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-15}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item APPLICATION
	\begin{itemize}
		\item 	\texttt{15155 There is still the page allocation failure with v1.0.3.13.}
		\item 	\texttt{15148[DMZ]DMZ ip address should not be the same with Lan ip address}
		\item	\texttt{13618[USB storage]If the Network/Device Name or workgroup contains special chars, add a check for them.}
		\item	\texttt{13336[WAN Setup]the WAN MTU can't work correctly}
	\end{itemize}
\end{enumerate}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.15.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-16}
\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item APPLICATION
	\begin{itemize}
		\item 	\texttt{15018 [USB Storage]Folder name with many spaces shows only one in Available \
						Network Folders on both USB Storage Basic settings and Advanced Settings page}
		\item 	\texttt{14960 [NETGEAR]Test ID (60) - Software -- Router -- LAN -- LAN \
						Configuration -- RIP-1 In}
		\item	\texttt{14961 [NETGEAR]Test ID (63) - Software -- Router -- LAN -- LAN \
						Configuration -- RIP-1 Both }
		\item	\texttt{13620 [USB storage]Webpage shows error when Network/Device Name \
						and Workgroup are some special characters}
		\item	\texttt{14794 [Wireless][a/n]Channel range of Africa shows wrong}
		\item	\texttt{14793 [Wireless][a/n]Channel range of Asia shows wrong}
		\item	\texttt{15154 [PPPoE]If the service name Contains special characters, it works error }
		\item	\texttt{15144 [DDNS]When time zone changes, the time in Show Status page does not change}
		\item	\texttt{15284 [NETGEAR] change help description to below red one for IR-23}
		\item	\texttt{15290 [NETGEAR] IR-7. Check with Bing}
		\item	\texttt{15294 [NETGEAR]when changing http external port for internet \
						access to the USB storage the link ins not updated}
		\item	\texttt{15297 [NETGEAR]when there is no USB device connected to the router \
						and I click on the button "Safely Remove USB Device" a pop-up is being \
						displayed.}
		\item	\texttt{15289 [NETGEAR] IR-6. Remove table is guest network if we only support \
						one guest network to prevent to trigger other tech. call.}
		\item	\texttt{15319 [NETGEAR] passwd cannot support special characters}
		\item	\texttt{15357 WDS GUI should be enabled}
		\item	\texttt{15318 [NETGEAR] When you enter an @IP as soon as the \
						field is full or as soon as you press the . the focus should \
						go on next field}
		\item	\texttt{15359 [NETGEAR] Auto tab issue.}
		\item 	\texttt{15310 changed scripts to fix WDS compatibility issue.}
		\item	\texttt{15287 [NETGEAR]"Allow Guest to access MY Local Network" is not work}
	\end{itemize}
\end{enumerate}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.16.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}

\subsection{Known issues}
        \begin{enumerate}
                \item \texttt{This version has been updated to Atheros LSDK 7.3.0.346.}
        \end{enumerate}

\section{Firmware V1.0.3.17}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-17}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{15296 [NETGEAR] VoIP issues}
		\item 	\texttt{15301 [NETGEAR] IR-27 Advanced Wireless setting and front button}
		\item 	\texttt{15369[NETGEAR] IR-55 Edit Network Folder dialog, if share name already exists}
		\item 	\texttt{15371[NETGEAR] IR58- Getting access to router filesystem (major bug)}
		\item 	\texttt{15372 Route Status shows disconnected when WDS repeater wireless connection is ok}
		\item 	\texttt{15368[NETGEAR] IR-54 If share name left empty in create network folder \
						dialog, error message reads 'share name cannot be NULL'}
		\item 	\texttt{15417 [NETGEAR-Ye] Slow wireless setting SOAP API response after LAN/WAN conflict}
		\item 	\texttt{14828[NETGEAR]Defect ID : 190 - When DDNS update failed because the \
						authentication failed the info showed in DDNS status page is incorrect.}
		\item 	\texttt{15318[NETGEAR] When you enter an @IP as soon as the field is full or as \
						soon as you press the . the focus should go on next field}
		\item 	\texttt{15439[NETGEAR] IR-78 Folder with German Umlauts will not be correct \
						displayed, please check screen shot "german umlaut.JPG"}
		\item 	\texttt{15407 DHCP MTU setting does not be applied}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.17.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-18}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{15443[NETGEAR] IR-88 DHCP lease time}
		\item 	\texttt{15406[WDS]MNU\_menu\_wds\_nolink.htm shows error}
		\item 	\texttt{15440[NETGEAR] IR-80 Window width for helptext way too small}
		\item 	\texttt{15475[NETGEAR]delete old usb storage pages}
		\item 	\texttt{Changed all the 145M to 130M}
		\item 	\texttt{15367[NETGEAR] IR-53 404 Not found when accessing wndr3700\/shares if http sharing disabled}
		\item 	\texttt{15365[NETGEAR] IR-49 routerlogin.com\/router-info.htm}
		\item 	\texttt{12771[WDS]When set Wireless Repeater, the "Wireless MAC of this router"display wrong.}
		\item 	\texttt{15531 DFS should be enabled}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.18.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-19}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{fixed [bug15446]I run client pin, but the description in GUI is PBC}
		\item 	\texttt{ fixed [bug15377]the trafficmeter web display bug}
		\item 	\texttt{Enabled HFS/HFS Plus supporting in kernel configuration file.}
		\item 	\texttt{disable country code IE in 5G}
		\item 	\texttt{Changed all the 145M to 130M}
		\item 	\texttt{fixed bug15301[NETGEAR] IR-27 Advanced Wireless setting and front button}
		\item 	\texttt{disable DFS & hidden traffic meter from GUI}
		\item 	\texttt{Applied Atheros patch for local\_bh\_enable issue}
		\item 	\texttt{Changed delay time to 58}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.19.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-3-20}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{Revert "fixed [bug15531]DFS should be enabled"}
		\item 	\texttt{fixed bug15440[NETGEAR] IR-80 Window width for helptext way too small}
		\item 	\texttt{for bug15288 [NETGEAR] Up to 130Mbps not Up to 145Mbps.}
		\item 	\texttt{fixed bug15367[NETGEAR] IR-53 404 Not found when accessing \
						http:\/\/wndr3700\/shares if http sharing disabled?}
		\item 	\texttt{fixed bug15443[NETGEAR] IR-88 DHCP lease time}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.3.20.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-20}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{Reserved a language table partition for multiple language string table.}
		\item 	\texttt{Enabled tar and gzip support in busybox configuration file.}
		\item 	\texttt{Disable art and mdk\_client support. they are just for wireless test. not neccessary...}
		\item 	\texttt{Applied the patch from Atheros to enable CONFIG\_SCSI\_MULTI\_LUN}
		\item 	\texttt{bug 15431, "IR-68 5GHz LED is blinking too fast at activity".}
		\item 	\texttt{[BUG 15660] [NETGEAR] IR-126 "remote login failure" entries in log}
		\item 	\texttt{[BUG 15657] [NETGEAR] IR-122 log entry}
		\item 	\texttt{[BUG 15675] Should support relatvie path in auto firmware upgrade}
		\item 	\texttt{15376[net-web]Multiple languages should be implemented}
		\item 	\texttt{15545 Both of WNDR3700 and AP94 don't recognize this flash \
						"PQI i231 Intelligent Stick 16GB USB Flash Drive".}
		\item 	\texttt{bug 15666 and 15667}
		\item 	\texttt{the type of argument pool\_num is changed and mempool\_num}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.20.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-21}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{15717 [NETGEAR]Defect ID : 267 - Statics Route}
		\item 	\texttt{15453 [NETGEAR]IR-95 DynDNS working but USB-Drive not accessable}
		\item 	\texttt{15815 [PortForwarding] When the DMZ is enabled. The UDP \
						port 53 for virtual server service does not work}
		\item 	\texttt{15293 [NETGEAR] IR-12 Able to use remote management even \
						I disable it after I enable HTTP(via internet) of USB storage access}
		\item 	\texttt{15432 [NETGEAR] IR-69 Attached Devices not showing all attached devices}
		\item 	\texttt{15292 [NETGEAR] IR-9 Day light saving not work at France.}
		\item 	\texttt{15298 [NETGEAR] IR-17 Guest network help file missing}
		\item 	\texttt{15533 Sometimes GUI still display device not removed \
						even USB device has been removed actually.}
		\item 	\texttt{15772 [NETGEAR] '[IR-038] share name link in USB settings \
						(basic) brings up error 'smb is not registered protocol' 
						in firefox}
		\item 	\texttt{15366 [NETGEAR]IR-52 'Access denied' message needed 
						when log in to protected shares over HTTP fails}
		\item 	\texttt{15760 [NETGEAR] All unicast, multicast, and broadcast packets 
						except ARP, RARP, and DHCP packets will be blocked \
						between user¡¯s local network¡±.}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.21.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}

\subsection{Known issues}
        \begin{enumerate}
                \item \texttt{This version has been updated to Atheros LSDK 7.3.0.360.}
        \end{enumerate}	

\section{Firmware V1.0.4.22}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-22}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{15303 [NETGEAR] IR-30 Unable to Safely remove}
		\item 	\texttt{15761 [Traffic Meter]Round up data volume for \
						each connection should work after you disconnect \
						the connection, not you reconnect the connection}
		\item 	\texttt{15763 [Traffic Meter]The behavior of charges at \
						least each time the user logs on is wrong.}
		\item 	\texttt{15762 [Traffic Meter]Round up data volume for each \
						connection will increase even the traffic is larger \
						than Round up data}
		\item 	\texttt{15764 [Traffic Meter]Reboot the DUT, Internet Traffic \
						Statistics will become all zero until you reconnect \
						the WAN connection}
		\item 	\texttt{15874 [Traffic Meter]The yesterday information of Traffic \
						Meter is always be NULL}
		\item 	\texttt{15827 [Traffic Meter]Restart traffic counter at X:XX \
						on the X day of each month can not auto restart counter}
		\item 	\texttt{15812 [Traffic Meter]Turn the Internet LED to flashing \
						green\/amber does not work When the monthly limit is \
						reached in Connection time control mode.}
		\item 	\texttt{15813 [Traffic Meter]Disconnect and disable the \
						Internet connection When the monthly limit is \
						reached does not work in Connection time control mode}
		\item 	\texttt{15816 [Traffic Meter]Disconnect and disable the Internet \
						connection When the monthly limit is reached does not \
						work in Traffic volume control mode}
		\item 	\texttt{15829 [Traffic Meter]Internet Traffic Statistics should \
						not become all zero if you restore to factory default}
		\item 	\texttt{15293 [NETGEAR] IR-12 Able to use remote management even \
						I disable it after I enable HTTP(via internet) of USB \
						storage access}
		\item 	\texttt{15659 [NETGEAR] IR-125 UPnP NAT rule add and delete}
		\item 	\texttt{15902 Should turn on USB LED when USB device is ready to use.}
		\item 	\texttt{15432 [NETGEAR] IR-69 Attached Devices not showing all attached devices}
		\item 	\texttt{15762 [NETGEAR] IR-86 WNDR3700 can't get device name of attached devices.}
		\item 	\texttt{15749 [Traffic Meter]Traffic Meter page should be grayed out if WAN \
						type is not PPPoE nor PPTP}
		\item 	\texttt{15760 [NETGEAR] All unicast, multicast, and broadcast packets \
						except ARP, RARP, and DHCP packets will be blocked between \
						user¡¯s local network¡±.}
		\item 	\texttt{15850 [soap]After run soap,the WPS status should "Configured"}
		\item 	\texttt{14016 [SQA Taipei-77]There is no LED for USB device.}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.22.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-23}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{16053 [trafficmeter]signal sent to the trafficmeter would \
						ivoke the sleep(60),to make connection time increase 1 \
						minutes ilegally.}
		\item 	\texttt{16181 [NETGEAR] 331 Loopback mode is not supported}
		\item 	\texttt{15865 [router status]when enable ¡°Disable \
						Wireless Client Association¡± in repeater mode in 5g,the \
						connection is ok, but in the "router status " shows \
						"disconnected".}
		\item 	\texttt{16047 firmware region should be displayed on GUI \
						when firmware upgrading.}
		\item 	\texttt{15754 [Traffic Meter]Traffic status page does not \	
						work because of js error}
		\item 	\texttt{15828 [Traffic Meter]Poll Interval can not work.}
		\item 	\texttt{15962 [NETGEAR][Lancelot] finish the USB spec. \
						v1.7 implementation like save hard disk info in \
						the router flash}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                \item \texttt{Please burn u-boot-3700V1.6.bin}
                \item \texttt{Set up a tftp server on your PC, its ip address is 192.168.1.12.}
                \item \texttt{Entering into boot loader}
                \item \texttt{ag7100> set serverip 192.168.1.12}
                \item \texttt{ag7100> tftp 0x80010000 u-boot-3700V1.6.bin}
				\item \texttt{ag7100> erase 0xbf000000 +0x70000}
				\item \texttt{ag7100> cp.b 0x80010000 0xbf000000 0x50000}
                \item \texttt{ag7100> reset}
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.23.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}

\subsection{Known issues}
        \begin{enumerate}
                \item \texttt{This version has been updated to Atheros LSDK 7.3.0.360.1.}
        \end{enumerate}

\section{Firmware V1.0.4.24}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-24}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{16101 [Trafffic Meter] The Connect button at the \
						Connection Status window should be grayed out when the limit \
						is reached so users cannot manually connect the PPPoE\/PPTP session}
		\item 	\texttt{16100 [Traffic Meter]I can paste Monthly limit as 1.5 hours and \
						apply on UI, but it does not work in function.}
		\item 	\texttt{16122 [PPTP]Copy from WPN824v3 : If PPTP internal ip of DUT is \
						the same subnet with external tunnel ip of DUT, can not ping \
						through from DUT to PPTP Server}
		\item 	\texttt{15902 Should turn on USB LED when USB device is ready to use.}
		\item 	\texttt{15476 [USB Storage]I can still input the unexist file name U:\\.\\.\\.\\.}
		\item 	\texttt{13618 [USB storage]If the Network/Device Name or workgroup \
						is special chars, the webpage shows error}
		\item 	\texttt{16191 [NETGEAR] Please remove Chinese, Korean, Japanese from 3700}
		\item 	\texttt{13341 [Multiple Language]Switch from one language to another \
						non-English language,if no Internet connection,there is no \
						¡°No Internet connection¡± message.}
		\item 	\texttt{13342 [Multiple Language]Please add ¡°Advanced->GUI Language¡± page.}
		\item 	\texttt{16178 [NETGEAR]capture all the strings in http server to language table.}
		\item 	\texttt{16081 [Wireless]"Unknown" is still shows in Available Wireless Cards \
						table even Attached Devices knows the device name}
		\item 	\texttt{15647 [NETGEAR]IR-120 DynDNS signature}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.24.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-25}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{16229 [NETGEAR] FTP should be enabled according to USB Spec v1.7}
		\item 	\texttt{16212 [NETGEAR]Defect ID : 340 eMule running on LAN PC gets low ID.}
		\item 	\texttt{13618 [USB storage]If the Network/Device Name or workgroup is specail
						chars, the webpage shows error }
		\item 	\texttt{16328 dhcp server shouldn't run on WDS repeater mode }
		\item 	\texttt{16400 [NETGEAR] Some changes for wireless settings }
		\item 	\texttt{16256 [WDS & USB] When DUT works in repeater mode, should not gray out USB link}
		\item 	\texttt{16345 [USB Storage]The limit of each configuration is defined here.}
		\item 	\texttt{15850 [soap]After run soap,the WPS status should "Configured"}
		\item 	\texttt{16420 [WPS]"Add WPS Client" menu grays out when wireless interface off}
		\item 	\texttt{16251 [NETGEAR]Defect ID : 342 DUT should fail to upgrade the \
						firmware if there's MD5 error in fileinfo file. }
		\item 	\texttt{15576 [NETGEAR] Defect ID : 262 - DUT lose internet \
						connection on Comcast cable after PC MAC address cloning }
		\item 	\texttt{16207 [NETGEAR]Defect ID : 335 - The first 3 octets of IP Address \
						of "DMZ" should not be gray out. It should be editable since LAN \
						subet can be set in in class A or B or C.}
		\item 	\texttt{16293 The concurrent throughput is worse than AP96}
		\item 	\texttt{15922 IOCELL -NetDISK Flash S5 black/silver 8GB \
						SKU16143121(beta1) cannot be auto mounted by wndr3700}
		\item 	\texttt{16236 [Traffic Meter]Counting Period shows error when first day of the month}
		\item 	\texttt{16232 [Traffic Meter]Amount Used on Traffic Status page is different \
						from Total Volume in Internet Traffic Statistics table}
		\item 	\texttt{16294 [USB Storage]USB LED should be off when ¡®Safely Remove Hardware¡¯ \
						button has been pressed in the GUI to shutdown attached USB device}
		\item 	\texttt{16267 change the WNDR3700 default SSID as User's requirement}
		\item 	\texttt{15926 [WDS]If change the DUT to WDS Repeater mode and set \
						Repeater IP as 192.168.1.2, then LAN IP Address and DHCP \
						starting IP address become the same}
		\item 	\texttt{15753 [Traffic Meter]It shows German in WW firmware}
		\item 	\texttt{16309 [DNI]when one device have multi disks, save and edit \
						share folder have error}
		\item 	\texttt{15873  	[NAPT Confilict] Needn't reserve UDP port for "Remote management"}
		\item 	\texttt{16152 [USB Storage]According to USB spec1.7, Remove the upper ¡°Apply¡± \
						button, as shown below. Clicking the ¡°Apply¡± button at \
						the bottom saves every setting on the page.}
		\item 	\texttt{16149 [USB Storage]According to USB spec1.7, the \
						Available Network Folders table should be changed.}
		\item 	\texttt{16153 [USB Storage]According to USB spec1.7, Display \
							the Access Method should be changed }
		\item 	\texttt{16165 [USB Storage]According to USB spec 1.7, 
						Change the HTTP access link from http://<Device Name>/shares \
						to http://rouerlogin.net/shares.}
		\item 	\texttt{16195 [NETGEAR] logo displayed wrong under 1024x768 }
		\item 	\texttt{15725 [Auto Firmware upgarde]When you click "Cancel" \
						button on "firmware Upgrade Assistant" page, \
						the process does not stop }
		\item 	\texttt{16150 [USB Storage]According to USB Spec1.7, if \
						there are many devices to unmount, the pop up windows \
						should be changed.}
		\item 	\texttt{16172 [USB Storage]According to USB Spec1.7, Some Exceptions}
		\item 	\texttt{16250 [NETGEAR]Defect ID : 341 Router GUI doesn't display the \
						release note for new firmware When auto FW upgrade from Website. }
		\item 	\texttt{16044 [DDNS]When "Automatically Adjust for Daylight Savings \
						Time" is checked, the update time on DDNS Status page shows error}
		\item 	\texttt{16047 firmware region should be displayed on GUI when firmware upgrading.}
		\item 	\texttt{16408 [Router Status]Should change the" /b/g/n" to "b/g/n"}
		\item 	\texttt{16345 [USB Storage]The limit of each configuration is defined here.}
		\item 	\texttt{15468 [WNDR3700-remote management]remoute management address can set with loopback address }
		\item 	\texttt{15759 [Traffic Meter]The max value of Monthly limit for Traffic volume control is too small }
		\item 	\texttt{15807 [Traffic Meter]According to Spec, should show Start Date/Time, \
						Current Date/Time, Traffic Volume Left information in Internet Traffic 
						Statistics}
		\item 	\texttt{15832 [Traffic Meter]There is no link to Traffic Meter help \
						page of each info in this page }
		\item 	\texttt{15966 [Multi-language]Change to Deutsch, it shows German}
		\item 	\texttt{15967 [Multi-language] When DUT reboot because of some \
						requirement from GUI, "Select language" field should be grayed out.}
		\item 	\texttt{15896 [Auto Upgrade]There is a javascript error if \
						uncheck "Check for Updated Firmware Upon Log-in" when login \
						Checking for Firmware Updates. }
		\item 	\texttt{16082 [Address Reservation Table]There is a JS error when \
						device in Address Reservation Table has no IP address}
		\item 	\texttt{16279 [Multi-language]There is a JS error in the hidden \
						page checkUpdate\_language.htm }
		\item 	\texttt{16211 [NETGEAR]Defect ID : 338 Cannot add a port triggering \
						rule with the triggering port set to 80. }
		\item 	\texttt{15979 [Multi-language]GR : Some strings still error when you select GR}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.25.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}

\subsection{Known issues}
        \begin{enumerate}
                \item \texttt{This version has been updated to Atheros LSDK 7.3.0.377. \
				The wireless script activateVAP is still from 7.3.0.360. Because Atheros has a bug in 7.3.0.377 activeVAP.}
        \end{enumerate}
		
\section{Firmware V1.0.4.26}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-26}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{16101 [Trafffic Meter] The Connect button at the Connection Status window \
						should be grayed out when the limit is reached so users cannot manually \
						connect the PPPoE/PPTP session}
		\item 	\texttt{16395 [Traffic Meter]Remaining data volume's value is wrong}
		\item 	\texttt{16234 [Traffic Meter]The numbers of Amount Used should \
						like 16:10/30 Hours for connection time }
		\item 	\texttt{15880 [Traffic Meter]The pop up warning message should be logged to router}
		\item 	\texttt{16469 [USB & FTP] The port for FTP(via internet) has been changed \
						from 21 to other port, but I can still login to FTP Server with port 21}
		\item 	\texttt{16285 [NETGEAR] Video mode on 5 GHz and Video mode on separate Video network}
		\item 	\texttt{16420 [WPS]"Add WPS Client" menu grays out when wireless interface off}
		\item 	\texttt{16207 [NETGEAR]Defect ID : 335 - The first 3 octets of IP Address of "DMZ" \
						should not be gray out. It should be editable since LAN subet can be set \
						in in class A or B or C. }
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.26.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}

\subsection{Known issues}
        \begin{enumerate}
                \item \texttt{This version has been updated to Atheros LSDK 7.3.0.378.}
        \end{enumerate}

\section{Firmware V1.0.4.27}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-27}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{FIX Bug 16499[USB & FTP]FTP(via internet) will not work if FTP is not enabled}
		\item 	\texttt{Fixed [BUG 16209] [NETGEAR] Defect ID : 337 - The Microsoft \
						UPnP Certification Test Tool auto test failed}
		\item 	\texttt{wndr3700-madwifi: Added the patch of changing LED blinking rate.}
		\item 	\texttt{in this version of madwifi-11n-scripts, we let wsc\_model\_number="V1H1".}
		\item 	\texttt{1. call API rtl8366s\_setMac5ForceLink() after rtl8366s\_initChip \
						2. add initial value 0 of regdata in function rtl8366s\_phy\_read \
						3. modify rtl8366s\_phy\_powerdown rtl8366s\_phy\_reset based on \
						Realtek suggested added rtl8366s\_phy\_powerup}
		\item 	\texttt{Fixed [BUG 16668] [NETGEAR] [Lancelot] USB storage domain \
						name changed for WNDR3700}
		\item 	\texttt{fixed bug16250[NETGEAR]Defect ID : 341 Router GUI doesn't display \
						the release note for new firmware When auto FW upgrade from Website.}
		\item 	\texttt{FIX Bug 16503[USB & FTP]The link of FTP(via internet) is error}
		\item 	\texttt{fixed bug16564[NETGEAR] Defect ID : 346 WPS IOT: after client PIN \
						process, it will not show the result page like success or time \
						out, but show the schedule bar all the time.}
		\item 	\texttt{fixed bug16589[DNI][wireless setting] a blank warning message in wireless seting page}
		\item 	\texttt{fixed bug16386[NETGEAR]add "Transmit Power Control" in the advanced wireless setting page}
		\item 	\texttt{fixed bug16470 On MNU\_menu\_wds\_nolink.htm, the link of Wireless Settings can be clicked}
		\item 	\texttt{fixed bug16565[NETGEAR]Defect ID : 347 Web GUI - After user clicks "Apply" or "Test" \
						button on "Dynamic IP Address" page GUI won't redirect the main pane to \
						"Basic Settings" page}
		\item 	\texttt{Support 'readyshare' domain name for HTTP USB sharing}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.27.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-28}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{Remove the USB LED keeping on timer from package "wndr3700-usbled"}
		\item 	\texttt{Run a process to set "/proc/usbled/state" periodically}
		\item 	\texttt{FIX BUG[16719]remove "get\_devnam\_fromlable" function in the scprit}
		\item 	\texttt{FIX BUG[16719]re-write "get\_devnam\_fromlabel" and add \
						"scan\_disk\_entries()" function}
		\item 	\texttt{FIX 15877 There is no Pop up warning message when X Mbytes \
						before the monthly limit is reach}
		\item 	\texttt{16407 [Traffic Meter]The warning message pop up before X \
						Mbytes before the monthly limit is reach}
		\item 	\texttt{fix bug 16738, "When client is granted access to DUT via \
						wireless ACL, DUT doesn't log the event."}
		\item 	\texttt{bug 16773, "[SQA-167]Input special characters in SSID field \
						and use airpeek program to capture beacon, both SSID names \
						display are not the same".}
		\item 	\texttt{Fixed [BUG 16499] [USB & FTP] FTP(via internet) will not work if FTP is not enabled;}
		\item 	\texttt{Fixed [BUG 16731] [USB & FTP] Only FTP(via internet) is enabled, but FTP works.}
		\item 	\texttt{fixed bug[16793][WPS-IOT]4965 wireless card has some issue with our DUT}
		\item 	\texttt{fixed bug16230[Multi-language & Basic Settings]Change from English to \
						other language, Internet Service Provider always sh after \
						change language , ppp type should not change}
		\item 	\texttt{fixed bug16514[NETGEAR/DNI-ST]Defect ID: 10 traffic meter \
						warning message is not accurate close file error}
		\item 	\texttt{fixed bug16772[SQA-166]Statistic page doesn't display value \
						of 11a\/n. can not get  "parent.an\_router\_flag" 's \
						value use "top.window.opener.an\_router\_flag"}
		\item 	\texttt{fixed bug16427[LAN Setup]Click "Apply" button on LAN Setup page \
						with IE6.0, the webpage can not return. when the ip not change, \
						add refresh time to 60 second}
		\item 	\texttt{fixed bug16414[Multi-language]Something wrong in RA firmware \
						item 1,2,5,6,8,9 have fixed 4.change "Auto" as multi-lang type \
						in wireless setting page 3,7 need translate}
		\item 	\texttt{fix bug 16753 1.check !netif\_queue\_stopped(dev) before dequeue \
						packet from queue 2.give a return value to ag7100\_qos\_start}
		\item 	\texttt{added ag7100 patch for CPU MAC reset work around code. \
						the code is from Atheros.}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.28.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-29}
\end{itemize}
\end{itemize}

\subsection{Module Updated}
\begin{itemize}
\item As below:
	\begin{itemize}
		\item 	\texttt{wndr3700-madwifi: change PKG\_GIT\_TREEISH to madwifi-11n-v7.3.0.385-dni1.}
		\item 	\texttt{wndr3700-madwifi-11n-scripts: change PKG\_GIT\_TREEISH to madwifi-11n-scripts-dual-v7.3.0.385-dni1.}
		\item 	\texttt{traffic\_meter has been updated to new tag V1.0.8}
		\item 	\texttt{wndr3700-hostapd: change PKG\_GIT\_TREEISH to hostapd-v7.3.0.385-dni1.}
		\item 	\texttt{ag7100 update PKT\_GIT\_TREEISH to 06d1cbc0f8df8faaa314d4f02c31dcc76723fd1c}
		\item 	\texttt{update net-web.git to V1.0.0.18}
	\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{16719 ftp shared folders is not consistent with the usb shared folders}
		\item 	\texttt{16743 [SQA-129][Traffic Meter]After first time setting up traffic meter, \
						the Traffic Status page amount used picture, which is in red color, \
						shows half full but the total amount usage is 0 Mbyte.}
		\item 	\texttt{16790 [SQA-130]Sometimes round up data volume does not be added \
						to the traffic statistics by manually disconnect PPP.}
		\item 	\texttt{15880 [Traffic Meter]The pop up warning message should be logged to router }
		\item 	\texttt{16504 [USB & FTP] If folder name or share name contain space, \
						the share folder will not show }
		\item 	\texttt{16501 [USB & FTP]Strange info in console }
		\item 	\texttt{15877 [Traffic Meter]There is no Pop up warning message \
						when X Mbytes before the monthly limit is reach }
		\item 	\texttt{16407 [Traffic Meter]The warning message pop up \
						before X Mbytes before the monthly limit is reach }
		\item 	\texttt{16500 [USB & FTP]While downloading through ftp from \
						USB storage, click "Safely remove USB Device" will unmout the USB device}
		\item 	\texttt{16787 [SQA-143]When we click "Safely Remove USB Device" button, GUI will \
						pop-up "Now you can remove this device." message but USB storage page \
						still displays USB device share folders and user can still read/write USB device.}
		\item 	\texttt{16740 [SQA-124][Log & Email]User will receive several emails but some emails' \
						content is "The system doesn't have any log messages yet.".}
		\item 	\texttt{16793 [WPS-IOT]4965 wireless card has some issue with our DUT }
		\item 	\texttt{15561 [SQA-112]When using the wired external registrar to configure DUT \
						security type as WPA2-PSK[AES], the GUI will display the security \
						as WPAPSK[TKIP]+WPA2-PSK[AES].}
		\item 	\texttt{16771 [SQA-165]The WDS function is enabled, \
						the Spanning tree protocol should be turn on automatically. \
						(Netgear spec 1.7 p.87) }
		\item 	\texttt{16262 [wds]when set dut as repeater mode,GUI SHOULD NOT \
						hijack the url ¡°routerlogin.net¡°, ¡­www.routerlogin.com. }
		\item 	\texttt{16768 [SQA-163]Configure wireless repeating function \
						wireless repeater mode, link rate always displays 11Mbps. }
		\item 	\texttt{16769 [SQA-164]Configure wireless repeating function \
						wireless Base mode, link rate always displays 130Mbps. }
		\item 	\texttt{16808 [Guest network]Click "Apply" on "Guest Network" \
						page, WPS link will gray out. }
		\item 	\texttt{14027 [SQA Taipei-84]Fragment packets increase a few \
						bytes larger than user defined. }
		\item 	\texttt{16767 [SQA-162]When user turns off the wireless repeater mode, \
						router should back to the default LAN side IP(192.168.1.1).}
		\item 	\texttt{16754 [SQA-147]There is no hyper link for help page of \
						"Does your internet conection require a login?" on \
						Basic Settings page. }
		\item 	\texttt{16785 [SQA-157]For Address Reservation, if users input the \
						same MAC, IP address, and device name which is already \
						recorded in current reservation pool, GUI SHOULD pop \
						out the message }
		\item 	\texttt{16749 [SQA-138]Under PPTP mode, my IP and PPTP server \
						IP can be configured to the same IP address. }
		\item 	\texttt{16750 [SQA-139]We can add a priority rule which \
						is the same as default QoS policy rules. }
		\item 	\texttt{16755 [SQA-148]Block services page "Service \
						Table" help page doesn't have quick link. }
		\item 	\texttt{16788 [SQA-140]When clicking on the router \
						upgrade button under Russia language, the AUTO\_search.htm \
						page displays unreadable characters.}
		\item 	\texttt{16290 [QoS]Should not add the same "QoS Policy" }
		\item 	\texttt{16775 [SQA-168]The illustration of WMM should not be on the Advanced Wireless Help page }
		\item 	\texttt{16402 [Auto Firmware upgrade]When auto firmware upgrading, the left menu can be click. }
		\item 	\texttt{16477 [Advance wireless settings]There is no default value for Transmit Power Control }
		\item 	\texttt{16418 [Multi-language]After upload wrong config file or wrong \
						image or select "no" in router upgrade page, select language is still grayed out}
		\item 	\texttt{16766 [SQA-161]If we enable the WDS function, the WPS client page should be grayed out.}
		\item 	\texttt{16414 [Multi-language]Something wrong in RA firmware }
		\item 	\texttt{16252 [DNS]I can not set the secondary DNS only. }
		\item 	\texttt{16228 [Upgrade]After firmware upgrade, it should show router status page }
		\item 	\texttt{16842 Blank web page will be displayed after auto firmware upgrade. }
		\item 	\texttt{16413 [Multi-language]Still something wrong in GR firmware}
		\item 	\texttt{16753 [SQA-146]Turn on bandwidth control and then \
						send UDP packets to cause DUT over the maximum bandwidth \
						value DUT will reboot itself.}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.29.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}

\subsection{Known issues}
        \begin{enumerate}
                \item \texttt{This version has been updated to Atheros LSDK 7.3.0.385.}
        \end{enumerate}
	
\section{Firmware V1.0.4.30}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-30}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{wndr3700-madwifi: change PKG\_GIT\_TREEISH to madwifi-11n-v7.3.0.385-dni2.}
		\item 	\texttt{traffic\_meter has been updated to new tag V1.0.9}
		\item 	\texttt{update net-web.git to V1.0.0.22}
		\item 	\texttt{update net-util.git to V1.0.2-dni}
	\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{16790 [SQA-130]Sometimes round up data volume does not be added to the \
				traffic statistics by manually disconnect PPP. }
		\item 	\texttt{16315 [Multi-language]after change GUI language, the auto upgrade \
				check version show wrong }
		\item 	\texttt{16749 [SQA-138]Under PPTP mode, my IP and PPTP server IP can be \
				configured to the same IP address.}
		\item 	\texttt{16788 [SQA-140]When clicking on the router upgrade button \
				under Russia language, the AUTO\_search.htm page displays unreadable characters.}
		\item 	\texttt{16771 [SQA-165]The WDS function is enabled, the Spanning tree protocol \
				should be turn on automatically.(Netgear spec 1.7 p.87)}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.30.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-31}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{ez-ipupdate to v3.0.10-dni-12}
		\item 	\texttt{ag7100-init to ab9c72c39fff3ae5d6a4d0d94cdcc6f6688d16a2}
		\item 	\texttt{update net-web.git to V1.0.0.29}
		\item 	\texttt{update net-util.git to V1.0.3-dni}
	\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{[Bug 16909][static route]the static route is still existing when \
				change it from active to non-act}
		\item 	\texttt{bug16178[NETGEAR]capture all the strings in http server to language table.}
		\item 	\texttt{Fixed [BUG 16886] [NETGEAR] Defect ID : 348 Auto FW upgrade \
				cheking upon log-in should not trigger the WAN connection}
		\item 	\texttt{bug16798[Attached devices]wnhde111 display "<unknown>"}
		\item 	\texttt{bug16684[Traffic Meter]characters like 890h should not be allow to be Poll interval}
		\item 	\texttt{bug14372[NETGEAR-Lancelot]The friendly name of LLTD is not right}
		\item 	\texttt{bug16436[Guest Network]Enable Guest Network will gray out "Add WPS client" link on left menu.}
		\item 	\texttt{bug16922[I][NETGEAR-Tai]remove JP from top list}
		\item 	\texttt{bug16922[II][NETGEAR-Tai]remove JP from top list}
		\item 	\texttt{[Bug 16529][NETGEAR] If there is no response from the DDNS service provider, DUT will not retry.}
		\item 	\texttt{[Bug 16525][NETGEAR] Leave the "myip" field in the DDNS update requests unspecified to let the server pick up}
		\item 	\texttt{[Bug 16519][NETGEAR] There's something wrong with the DDNS logs.}
		\item 	\texttt{Bug 16876 If FTP is enabled,wndr3700 cannot connect to PPPoE server after disconnect and then connect.}
		\item 	\texttt{bug 16880 modify atheros workaround code for can not detect rx hange correctly}
		\item 	\texttt{bug16937[NETGEAR-Tai]The value of "md5" for firmware and language table should ignore upper and \
				lower case letters. when compare the md5 value, ignore upper and lower case letters}
		\item 	\texttt{bug16844[upgrade]when you upgrade from a high version to a low version.the warning should be modified.}
		\item 	\texttt{bug16667[NETGEAR-49 Smart Wizard ]Web GUI - after user clicks the "Apply" \
				or "Test" button in "Dynamic IP Address"}
		\item 	\texttt{16951[NETGEAR] Defect ID : 376 In GUI setup wizard flow, if detected WAN is \
				static ip and you input all the ip a load config value in setup Wizard pages}
		\item 	\texttt{bug16961[NETGEAR]GR time format change and GR string correct}
		\item 	\texttt{bug16977[NETGEAR 398] Release notes display error when use auto internet firmware upgrade.}
		\item 	\texttt{bug16990[NETGEAR]Defect ID : 112 [USB] Approved Devices list doesnt show all approved devices}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.31.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item Branch: \texttt{sh\_sw\_one\_br}
    \item Tag: \texttt{WNDR3700U-V-1-0-4-32}
\end{itemize}
\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{trafficmeter to trafficmeter-v1.1.0-dni2}
		\item 	\texttt{net-web to net-web-dni32}
	\end{itemize}
...
\item As below:
	\begin{itemize}
		\item 	\texttt{bug[16995][NETGEAR-WPS]there is no LED blinking during AP PIN running}
		\item 	\texttt{FIX bug about modifying polling time to 1 second from 60 seconds in trafficmeter}
		\item 	\texttt{[BUG 17121] [NETGEAR] OpenDNS should be enabled}
		\item 	\texttt{BUG 17122[NETGEAR] Traffic meter should support DHCP and static}
		\item 	\texttt{16919 [Traffic Meter]Amount Used shows error even the month limit is reached}
		\item 	\texttt{16990 [NETGEAR]Defect ID : 112 [USB] Approved Devices list \
						doesnt show all approved devices }
		\item 	\texttt{16961 [NETGEAR]GR time format change and GR string correct}
	\end{itemize}
...
\item As below:
        \begin{enumerate}
                ...
                \item \texttt{Entering into boot loader again}
                \item \texttt{ag7100>bootm}
                \item \texttt{Then the device should be in tftp recovery mode. Please run the command "tftp -i 192.168.1.1 put WNDR3700U-V1.0.4.32.img" on MS-DOS of your PC.}
        \end{enumerate}
\end{itemize}
